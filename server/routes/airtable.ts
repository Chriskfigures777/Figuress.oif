...
import { AirtableContactData } from "@shared/api";

export const handleAirtableSubmission: RequestHandler = async (req, res) => {
  try {
    const { name, email, phone }: AirtableContactData = req.body;
